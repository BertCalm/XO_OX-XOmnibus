...
final class SpecimenFactory {
    ...
    static func create(
        ...
        // Seasonal cosmetic bonus — reserved for future LimitedTimeEvent.bonusCosmeticTier support
        let resolvedCosmeticTier: CosmeticTier = .standard
    ...
    static func createStarter() -> Specimen {
        ...
        return Specimen(
            ...
            // Use catalog defaults so starter sound matches the Sawfin catalog entry.
            // Warm, filtered, soft attack, light reverb — the first sound must invite.
            parameterState: SpecimenCatalog.entry(for: "polyblep-saw")?.defaultParams ?? [
                "obrix_src1Type": 0,
                "obrix_src1Tune": 0,
                "obrix_src1Level": 0.75,
                "obrix_flt1Cutoff": 0.5,
                "obrix_flt1Resonance": 0.12,
                "obrix_env1Attack": 0.03,
                "obrix_env1Decay": 0.35,
                "obrix_env1Sustain": 0.65,
                "obrix_env1Release": 0.55,
                "obrix_lfo1Rate": 0.25,
                "obrix_lfo1Depth": 0.08,
                "obrix_fx1Mix": 0.3,
                "obrix_fx1Param1": 0.5,
            ],
            catchLatitude: nil,
