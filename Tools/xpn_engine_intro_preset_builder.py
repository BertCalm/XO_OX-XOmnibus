...
Usage:
    ...
    python xpn_engine_intro_preset_builder.py --engine OCEANDEEP --output-dir Presets/XOmnibus/
...
Examples:
  ...
  python xpn_engine_intro_preset_builder.py --engine OUIE --output-dir Presets/XOmnibus/ --dry-run
        """,
    )
    parser.add_argument(
        "--engine",
