...
Generate high-movement presets for kinetic engines in XOceanus.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Generate high-movement Flux presets for XOceanus kinetic engines."
    )
    parser.add_argument(
        "--output-dir",
        default="Presets/XOceanus/Flux/",
        help="Directory to write preset JSON files (default: Presets/XOceanus/Flux/)",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
