...
--------------------------------
Tracks XOceanus preset fleet evolution over git history.
...
def build_report(
    ...
    h("XOceanus Preset Fleet — Evolution Tracker")
...
def main():
    parser = argparse.ArgumentParser(
        description="Track XOceanus preset fleet evolution via git history.",
