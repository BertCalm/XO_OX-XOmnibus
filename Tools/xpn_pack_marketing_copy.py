...
def gen_product_description(
    ...
    desc = (
        ...
        f"Engines: {engine_list}. Designed for Akai MPC Live and MPC X, and the XOmnibus AU/VST3 plugin. "
...
def gen_short_description(
    ...
    return (
        ...
        f"Ready for MPC and XOmnibus. No compromise."
    )
...
def gen_feature_bullets(
    ...
    bullets = [
        ...
        f"✦ Velocity-expressive, MPC-ready, XOmnibus AU/VST3 compatible",
    ]
    return bullets
