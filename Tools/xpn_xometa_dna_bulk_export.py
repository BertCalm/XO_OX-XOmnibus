...
Examples:
  ...
  python xpn_xometa_dna_bulk_export.py ../Presets/XOceanus/

  # Filter to OPAL engine, JSON output
  python xpn_xometa_dna_bulk_export.py ../Presets/XOceanus/ --engine OPAL --format json

  # Markdown summary to file
  python xpn_xometa_dna_bulk_export.py ../Presets/XOceanus/ --format markdown --output dna_report.md
"""
