#!/usr/bin/env python3
"""Generate OBESE + OVERBITE coupling pack for XOmnibus.
...
All presets written to Presets/XOmnibus/Entangled/.
"""
...
# Engine name → XOmnibus engine key (used in "engines" array and coupling pairs)
ENGINE_KEY = {
    "OBESE":     "XObese",
    "OVERBITE":  "XOverbite",
    "OBLONG":    "XOblong",
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate OBESE + OVERBITE coupling pack presets for XOmnibus."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
