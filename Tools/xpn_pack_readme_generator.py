...
ENGINE_DESCRIPTIONS: dict[str, str] = {
    ...
    "OVERDUB": (
        ...
        "the most performance-oriented engine in XOceanus."
    ),
    "ODDFELIX": (
...
> Designed by XO_OX | Part of the XOceanus instrument ecosystem
...
Designed by XO_OX | XOceanus Pack v{version} | Free to use in commercial productions
