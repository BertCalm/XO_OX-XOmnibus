...
# ---------------------------------------------------------------------------
# Known XOmnibus engines (canonical short names)
# ---------------------------------------------------------------------------
KNOWN_ENGINES = {
...
def config_from_spec(spec_path: Path, overrides: dict) -> dict:
    ...
    preset_dir = pack.get("preset_dir") or spec.get("preset_dir") or "Presets/XOmnibus/Foundation"
...
def config_defaults(overrides: dict) -> dict:
    ...
    return {
        ...
        "secondary_engines": [],
        "preset_dir": "Presets/XOmnibus/Foundation",
