...
# Sourced from engine_registry.py (synced to CLAUDE.md / PresetManager.h).
# Do NOT maintain a local color table here — update engine_registry.py instead.
# =============================================================================

ENGINE_PAD_COLORS = {name: get_color(name) for name in get_all_engines()}
...
def _generate_qlink_xml() -> str:
    ...
    return (
        '    <QLinks>\n'
        '      <QLink number="1">\n'
        '        <Name>CHARACTER</Name>\n'            # ≤10 chars — XOceanus macro 1
        '        <Parameter>FilterCutoff</Parameter>\n'
        '        <Min>0.200000</Min>\n'
        '        <Max>1.000000</Max>\n'
        '      </QLink>\n'
        '      <QLink number="2">\n'
        '        <Name>MOVEMENT</Name>\n'             # ≤10 chars — XOceanus macro 2
        '        <Parameter>LFORate</Parameter>\n'
        '        <Min>0.000000</Min>\n'
        '        <Max>1.000000</Max>\n'
        '      </QLink>\n'
        '      <QLink number="3">\n'
        '        <Name>COUPLING</Name>\n'             # ≤10 chars — XOceanus macro 3
        '        <Parameter>Send2</Parameter>\n'
        '        <Min>0.000000</Min>\n'
        '        <Max>0.700000</Max>\n'
        '      </QLink>\n'
        '      <QLink number="4">\n'
        '        <Name>SPACE</Name>\n'                # ≤10 chars — XOceanus macro 4
