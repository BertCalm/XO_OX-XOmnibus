...
live engine coupling from XOmnibus inside their DAW.
...
Usage:
    ...
    python xpn_coupling_recipes.py --presets ./Presets/XOmnibus/Entangled/ \\
...
class CouplingRecipe:
    ...
    xpn_note: str = (
        ...
        "Load XOmnibus with this coupling configuration to hear the live version."
    )
...
def _extract_macro_positions(preset: dict) -> dict[str, float]:
    ...
    XOmnibus stores macros under each engine's parameter dict as
...
def _build_setup_instructions(
    ...
    inside XOmnibus to recreate the coupling.
    """
    steps: list[str] = []
    step = 1
...
COLLECTION_ROUTING_TABLES: dict[str, dict] = {
    "kitchen": {
        ...
        "xpn_note": (
            ...
            "Load all engines in XOmnibus and apply the Fusion routing to hear "
    ...
    "travel": {
        ...
        "xpn_note": (
            ...
            "Load all four Travel sets plus Sable Island in XOmnibus and apply "
    ...
    "artwork": {
        ...
        "xpn_note": (
            ...
            "Load the full color quad in XOmnibus and apply Complementary Color routing "
