...
Generates evocative 1-2 sentence descriptions for XOmnibus presets that are
missing them.
...
PRESETS_ROOT = pathlib.Path(__file__).parent.parent / "Presets" / "XOmnibus"
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate descriptions for XOmnibus presets that are missing them."
    )
