...
def generate_coupling_comment(
    ...
    Args:
        ...
        xoceanus_version: XOceanus version string.
    ...
    lines.append(
        ...
        f'xoceanus_version="{xoceanus_version}" render_date="{render_date}" />'
    )
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--xoceanus-version",
        default="1.0",
        help="XOceanus version string (default: 1.0).",
    )
    parser.add_argument(
        "--render-date",
        default=None,
...
def main() -> None:
    ...
    try:
        comment_block = generate_coupling_comment(
            ...
            xoceanus_version=args.xoceanus_version,
