#!/usr/bin/env python3
"""
xpn_auto_dna.py — Automatically computes XOmnibus 6D Sonic DNA values from WAV audio.
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "xpn_auto_dna — compute XOmnibus 6D Sonic DNA from WAV audio (stdlib only)\n\n"
