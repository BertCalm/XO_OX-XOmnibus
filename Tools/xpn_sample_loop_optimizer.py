#!/usr/bin/env python3
"""
xpn_sample_loop_optimizer.py — XO_OX XOmnibus Tool
...
def build_report(wav_path: Path, fmt: dict, samples: list,
    ...
    lines = []
    lines.append("=" * 60)
    lines.append("XPN Sample Loop Optimizer — XO_OX XOmnibus")
    lines.append("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Analyze WAV files for loop optimization (XO_OX XOmnibus)."
    )
