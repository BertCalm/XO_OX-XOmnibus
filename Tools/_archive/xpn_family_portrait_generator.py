#!/usr/bin/env python3
"""
xpn_family_portrait_generator.py — XOceanus Family Portrait Preset Generator
...
# ---------------------------------------------------------------------------
# 6D Sonic DNA baselines for all 34 registered XOceanus engines
# ---------------------------------------------------------------------------
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate XOceanus Family Portrait presets (2 variants per concept).",
    )
    parser.add_argument(
        "--output-dir",
        default=None,
        help="Destination directory (default: <repo>/Presets/XOceanus/Family/)",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
...
def _resolve_output_dir(arg) -> pathlib.Path:
    ...
    # Default: <repo root>/Presets/XOceanus/Family/
    repo_root = pathlib.Path(__file__).parent.parent
    return repo_root / "Presets" / "XOceanus" / "Family"
