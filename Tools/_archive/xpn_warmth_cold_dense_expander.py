...
Populates the four under-represented warmth/density quadrants in the XOceanus
...
def generate_quadrant(quadrant, repo_root, rng, dry_run, verbose):
    ...
    out_dir = repo_root / "Presets" / "XOceanus" / cfg["subdir"]
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Fill warmth/density extreme quadrants in the XOceanus preset fleet.",
