#!/usr/bin/env python3
"""Generate OSPREY + OSTERIA coupling presets for XOceanus.
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate OSPREY + OSTERIA coupling presets for XOceanus."
    )
    parser.add_argument(
        "--output-dir",
        default=None,
        help="Output directory (default: Presets/XOceanus/Entangled/ relative to repo root).",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
