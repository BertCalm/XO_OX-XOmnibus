...
Output: Presets/XOmnibus/Atmosphere/ and Presets/XOmnibus/Prism/
"""
...
def generate_section(mood, corners, suffix, engine_cycle, coupling_cycle):
    out_dir = os.path.join(REPO_ROOT, 'Presets', 'XOmnibus', mood)
...
def main():
    ...
    pri_dir = os.path.join(REPO_ROOT, 'Presets', 'XOmnibus', 'Prism')
    ...
    print(f"\nTotal .xometa in Presets/XOmnibus/Atmosphere/: {atm_count}")
    print(f"Total .xometa in Presets/XOmnibus/Prism/:      {pri_count}")
