...
for XOceanus engines. Targets thick analog bass and saturated pads in the
...
Usage:
    ...
    python3 xpn_hot_dense_preset_pack.py --output-dir Presets/XOceanus/Foundation/ --seed 42
"""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Generate Hot Dense quadrant presets for XOceanus engines.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=__doc__,
    )
    parser.add_argument(
        "--output-dir",
        default="Presets/XOceanus/Foundation/",
        help="Output directory for generated presets (default: Presets/XOceanus/Foundation/)",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
