...
Output:
  Presets/XOceanus/Aether/  — 40 presets
  Presets/XOceanus/Family/  — 40 presets
...
AETHER_DIR = os.path.join(REPO_ROOT, 'Presets', 'XOceanus', 'Aether')
FAMILY_DIR = os.path.join(REPO_ROOT, 'Presets', 'XOceanus', 'Family')
