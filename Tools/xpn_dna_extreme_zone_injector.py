...
PRESETS_ROOT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "Presets", "XOmnibus")
...
def main():
    ...
    for corner_name, mood, presets in ALL_CORNERS:
        ...
        for p in presets:
            ...
            total += 1
        print(f"[{corner_name}] wrote {len(written)} presets → Presets/XOmnibus/{mood}/")
        for w in written:
            print(f"  {w}")
