...
def build_pack_spec():
    return {
        ...
        "target_audience": (
            ...
            "Producers who want a taste of all three flagship engines before committing to the full XOceanus library."
        ),
        "description": (
        ...
        "marketing_hooks": [
            ...
            "Entangled program shows XOceanus engine coupling: rhythms that breathe, pads that pulse.",
            "Gateway to the full XOceanus library — every engine here has a deeper version in the main release.",
        ...
        "build_notes": {
            "preset_references": (
                ...
                "XOceanus preset IDs during the XPN build step."
            ),
...
It showcases three core engines from XOceanus — ONSET, ODYSSEY, and OPAL — in a single
...
TIDE TABLES is a taste. The full XOceanus library contains **31+ engines**,
