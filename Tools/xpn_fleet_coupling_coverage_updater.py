...
def print_report(
    ...
    print("=" * 64)
    print("  XOmnibus Fleet Coupling Coverage Report")
    print("=" * 64)
    print()
...
def main():
    ...
    default_presets = repo_root / "Presets" / "XOmnibus" / "Entangled"

    parser = argparse.ArgumentParser(
        description="Report XOmnibus fleet coupling coverage toward 561-pair goal.",
