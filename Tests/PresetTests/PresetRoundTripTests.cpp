...
{
    const char* json = R"({"schema_version":1,"name":"M","mood":"InvalidMood","engines":["Snap"],"parameters":{"Snap":{}}})";
    PresetManager pm;
...
{
    const char* json = R"({"schema_version":1,"name":"A","mood":"Foundation","engines":["Fake1","Fake2"],"parameters":{}})";
    PresetManager pm;
    CHECK(!pm.loadPresetFromJSON(juce::String(json)));
}
...
{
    const char* json = R"({"schema_version":0,"name":"B","mood":"Foundation","engines":["Snap"],"parameters":{"Snap":{}}})";
    PresetManager pm;
    CHECK(!pm.loadPresetFromJSON(juce::String(json)));
}
...
TEST_CASE("PresetManager - dnaDistance(a,a) = 0", "[preset][dna]")
{
    PresetManager pm;
    PresetDNA a;
    a.brightness = 0.5f; a.warmth = 0.3f; a.movement = 0.7f;
    a.density = 0.1f;    a.space   = 0.9f; a.aggression = 0.4f;
...
TEST_CASE("PresetManager - findSimilar returns presets sorted by distance", "[preset][dna]")
{
    auto makePreset = [](const char* name, float brightness) {
        PresetData p;
        p.schemaVersion = 1; p.name = name;
        p.mood = "Foundation"; p.engines.add("Snap");
