...
Deep, comprehensive repo health scan that finds inconsistencies, drift, and technical debt across the entire XOceanus codebase. Like a Roomba — thorough, systematic, and leaves things cleaner than it found them.
...
1. **Registry Completeness**
   - Read `Source/XOceanusProcessor.cpp` — extract all `registerEngine("CanonicalName", ...)` calls
...
2. **Master Spec Drift**
   - If Docs/specs/xoceanus_master_specification.md exists, check engine count claims
