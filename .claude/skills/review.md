...
Structured code review tailored for audio/synth plugin development. Catches architecture violations, audio thread safety issues, and XOceanus-specific gotchas.
