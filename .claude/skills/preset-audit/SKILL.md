---
name: preset-audit
description: Health check on XOceanus presets. Use when auditing preset quality, checking for duplicates, validating DNA coverage, verifying schema compliance, or reviewing preset naming conventions.
...
All factory presets: `Presets/XOceanus/{mood}/*.xometa`
