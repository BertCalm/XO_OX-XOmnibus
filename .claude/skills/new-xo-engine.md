...
Walk through ideation, architecture, scaffold, and integration of a new XOmnibus engine.
Referenced in CLAUDE.md. Full process documented in `Docs/xomnibus_new_engine_process.md`.
...
5. **Create sound design entry** — `Docs/xomnibus_sound_design_guides.md`
