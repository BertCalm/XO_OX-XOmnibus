...
- No duplicates against existing factory presets in `Presets/XOmnibus/`

### 6. Output

Write the offspring `.xometa` file:
- Place in appropriate mood folder: `Presets/XOmnibus/{mood}/`
...
- **File:** Presets/XOmnibus/{mood}/{filename}.xometa
```
