...
Quick, focused health check for a specific XOceanus subsystem. Lighter than /roomba, designed for rapid validation after making changes to one area.
...
1. Parse all .xometa files under Presets/XOceanus/
...
4. Check XOceanusProcessor for MPE zone manager integration
