---
name: Bug Report
about: Report an audio bug, crash, or unexpected behavior
title: "[BUG] "
labels: bug
assignees: ''
---
...
## Engine(s) Affected
<!-- Which engine(s) does this affect? e.g., OPAL, ONSET, all engines -->
...
- **XOceanus version / commit**: <!-- e.g., 1.0.0, or commit SHA for dev builds -->
