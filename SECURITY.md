...
If you discover a security vulnerability in XOceanus, please report it responsibly:
...
XOceanus is an audio plugin that processes audio signals locally. The primary security concerns are:
