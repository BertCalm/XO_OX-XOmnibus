...
2. **Demonstrate** -- show what XOceanus coupling can do that other synths cannot
...
6. **Pair It With**: 2-3 complementary XOceanus presets or engine combinations.
...
1. Design preset in XOceanus (save as .xometa)
