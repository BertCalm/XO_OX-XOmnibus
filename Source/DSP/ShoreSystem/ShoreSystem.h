...
static constexpr ShoreCreatures kShoreCreatures[5] = {
    // ATLANTIC
    {{{"StormPetrel",
       {2500.0f, 4200.0f, 6800.0f},
       {3800.0f, 5500.0f, 8000.0f},
      ...
      {"HumpbackWhale",
       {80.0f, 250.0f, 600.0f},
       {200.0f, 500.0f, 1200.0f},
       {30.0f, 60.0f, 100.0f},
       3000.0f,
       8000.0f,
       0.6f},
      {"HarborFoghorn",
       {120.0f, 350.0f, 800.0f},
       {120.0f, 350.0f, 800.0f},
       {40.0f, 70.0f, 120.0f},
       4000.0f,
       15000.0f,
    ...
    // NORDIC
    {{{"ArcticTern",
       {3000.0f, 5000.0f, 7500.0f},
       {4500.0f, 6500.0f, 9000.0f},
       {350.0f, 450.0f, 550.0f},
       80.0f,
       3000.0f,
       0.35f},
      {"BelugaWhale",
       {400.0f, 1200.0f, 3000.0f},
       {800.0f, 2000.0f, 5000.0f},
       {80.0f, 150.0f, 250.0f},
       800.0f,
       4000.0f,
       0.5f},
    ...
    // MEDITERRANEAN
    {{{"MedGull",
       {2200.0f, 3800.0f, 6000.0f},
       {3200.0f, 5000.0f, 7500.0f},
       {280.0f, 380.0f, 480.0f},
       200.0f,
       1500.0f,
       0.4f},
      {"DolphinClick",
       {1000.0f, 4000.0f, 8000.0f},
       {1200.0f, 4500.0f, 9000.0f},
       {200.0f, 400.0f, 600.0f},
       15.0f,
       300.0f,
       0.3f},
      {"CicadaDrone",
       {4000.0f, 6000.0f, 8500.0f},
       {4000.0f, 6000.0f, 8500.0f},
       {500.0f, 700.0f, 900.0f},
       10000.0f,
       2000.0f,
       0.25f}}},
    // PACIFIC
    {{{"Albatross",
       {1800.0f, 3200.0f, 5500.0f},
       {2200.0f, 3800.0f, 6500.0f},
       {250.0f, 350.0f, 450.0f},
       300.0f,
       5000.0f,
       0.3f},
      {"PacificWhale",
       {60.0f, 180.0f, 450.0f},
       {300.0f, 700.0f, 1500.0f},
       {25.0f, 50.0f, 90.0f},
       5000.0f,
       12000.0f,
       0.65f},
      {"ReefCrackle",
       {800.0f, 3000.0f, 7000.0f},
       {1200.0f, 4000.0f, 9000.0f},
       {400.0f, 600.0f, 800.0f},
       30.0f,
       100.0f,
       0.2f}}},
    // SOUTHERN
    {{{"Tropicbird",
       {2800.0f, 4500.0f, 7000.0f},
       {2000.0f, 3200.0f, 5000.0f},
       {320.0f, 420.0f, 520.0f},
       150.0f,
       2500.0f,
       0.35f},
      {"SouthernWhale",
       {50.0f, 150.0f, 400.0f},
       {100.0f, 300.0f, 800.0f},
       {20.0f, 45.0f, 80.0f},
       4000.0f,
       10000.0f,
       0.7f},
      {"TropicalRain",
       {2000.0f, 5000.0f, 9000.0f},
       {2000.0f, 5000.0f, 9000.0f},
       {800.0f, 1200.0f, 1500.0f},
       30000.0f,
       5000.0f,
       0.3f}}}};
...
inline FluidCharacter morphFluid(const ShoreMorphState& m) noexcept
{
    ...
    return {lerp(a.swellPeriodBase, b.swellPeriodBase, m.frac),
...
inline TavernCharacter morphTavern(const ShoreMorphState& m) noexcept
{
    ...
    return {(m.frac < 0.5f) ? a.name : b.name,  lerp(a.roomSizeMs, b.roomSizeMs, m.frac),
            lerp(a.decayMs, b.decayMs, m.frac), lerp(a.absorption, b.absorption, m.frac),
            lerp(a.warmth, b.warmth, m.frac),   lerp(a.murmurBrightness, b.murmurBrightness, m.frac),
...
inline ShoreRhythm morphRhythm(const ShoreMorphState& m) noexcept
{
    ...
    return {(m.frac < 0.5f) ? a.name : b.name, lerp(a.pulseRate, b.pulseRate, m.frac), lerp(a.swing, b.swing, m.frac),
