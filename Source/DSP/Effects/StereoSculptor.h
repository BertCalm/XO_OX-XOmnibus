...
private:
    ...
    {
        float out =
            lp1Coeffs.b0 * in + lp1Coeffs.b1 * s.x1 + lp1Coeffs.b2 * s.x2 - lp1Coeffs.a1 * s.y1 - lp1Coeffs.a2 * s.y2;
        s.x2 = s.x1;
        s.x1 = in;
        s.y2 = s.y1;
        s.y1 = out;
    ...
    {
        float out =
            hp2Coeffs.b0 * in + hp2Coeffs.b1 * s.x1 + hp2Coeffs.b2 * s.x2 - hp2Coeffs.a1 * s.y1 - hp2Coeffs.a2 * s.y2;
        s.x2 = s.x1;
        s.x1 = in;
        s.y2 = s.y1;
        s.y1 = out;
    ...
    void flushAllStates()
    {
        ...
        {
            s.x1 = flushDenormal(s.x1);
            s.x2 = flushDenormal(s.x2);
            s.y1 = flushDenormal(s.y1);
            s.y2 = flushDenormal(s.y2);
        };
        flush(lp1StateL);
        flush(lp1StateR);
        flush(hp2StateL);
