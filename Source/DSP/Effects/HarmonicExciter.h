...
private:
    ...
    {
        float out =
            hpfCoeffs.b0 * in + hpfCoeffs.b1 * s.x1 + hpfCoeffs.b2 * s.x2 - hpfCoeffs.a1 * s.y1 - hpfCoeffs.a2 * s.y2;
        s.x2 = s.x1;
        s.x1 = in;
        s.y2 = s.y1;
        s.y1 = out;
    ...
    {
        float out = toneCoeffs.b0 * in + toneCoeffs.b1 * s.x1 + toneCoeffs.b2 * s.x2 - toneCoeffs.a1 * s.y1 -
                    toneCoeffs.a2 * s.y2;
        s.x2 = s.x1;
        s.x1 = in;
        s.y2 = s.y1;
