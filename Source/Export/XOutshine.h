...
// SampleCategory enum + helpers are in SampleCategory.h (included above namespace)
...
// Rebirth includes moved before namespace (SampleCategory.h, RebirthProfiles.h, RebirthPipeline.h)
