...
//------------------------------------------------------------------------------
inline void buildKWeightingFilters(double sampleRate, KWeightingFilter& stage1, KWeightingFilter& stage2)
{
...
//------------------------------------------------------------------------------
inline float computeIntegratedLUFS(const juce::AudioBuffer<float>& buffer, double sampleRate)
{
