...
private:
    ...
    static BiomeProfile profileForIndex(int index)
    {
        ...
        {
        case 1:
            return getUnderwaterProfile();
        case 2:
            return getWinterProfile();
        default:
            return getJungleProfile();
        }
    }
    ...
    static BiomeProfile lerp(const BiomeProfile& a, const BiomeProfile& b, float t)
    {
        ...
        return {
            mix(a.floorDampingBase, b.floorDampingBase),         mix(a.floorBrightnessBase, b.floorBrightnessBase),
            mix(a.understoryWobbleBase, b.understoryWobbleBase), mix(a.understoryBitShift, b.understoryBitShift),
            mix(a.canopyPartialTilt, b.canopyPartialTilt),       mix(a.canopyBreathePeriod, b.canopyBreathePeriod),
            mix(a.emergentPitchRange, b.emergentPitchRange),     mix(a.emergentDecayBase, b.emergentDecayBase),
            mix(a.humidityCharacter, b.humidityCharacter),       mix(a.reverbPreDelayMs, b.reverbPreDelayMs),
