...
public:
    ...
    static LayoutConstants getConstants(LayoutMode mode)
    {
        switch (mode)
        {
            ...
            case LayoutMode::iPadCompact:
                return {
                    44.0f, 56.0f, 44.0f, 160.0f,
                    32.0f, 70.0f, 180.0f, 100.0f,
            ...
            case LayoutMode::Desktop:
                return {
                    48.0f, 0.0f, 80.0f, 80.0f,
                    40.0f, 120.0f, 200.0f, 0.0f,
    ...
    void addListener(LayoutChangeCallback cb)
    {
    ...
    static bool meetsMinTouchTarget(float widthPt, float heightPt)
    {
        return widthPt >= 44.0f && heightPt >= 44.0f;
    }
    ...
    juce::Rectangle<float> getUsableBounds(float totalWidth, float totalHeight) const
    {
        return {
            safeArea.left,
            safeArea.top,
            totalWidth - safeArea.left - safeArea.right,
