...
private:
    ...
    void buildLayout()
    {
        ...
        // ---- Right side: #23 status bar consolidation ----
        ...
        // LATCH badge (only visible in KEYS mode when latch active)
        {
        ...
        // CPU meter (small text display, right of voices)
        {
    ...
    // #23: Status bar consolidation — additional state
