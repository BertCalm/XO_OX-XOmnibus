...
class OutshineInputPanel : public juce::Component, public juce::FileDragAndDropTarget
{
public:
    ...
    void paint(juce::Graphics& g) override
    {
        ...
        if (isModeA)
        {
            ...
            g.drawText(
                "WAV \xe2\x80\xa2 Folders \xe2\x80\xa2 XPN",
                dropZoneArea.withHeight(dropZoneArea.getHeight() / 2).translated(0, dropZoneArea.getHeight() / 4 + 10),
                juce::Justification::centred);
        }
    }
...
private:
    void buildModeB()
    {
        ...
        tabComponent->addTab("Browse Files", GalleryColors::get(GalleryColors::shellWhite()), tabFolderBrowser.get(),
                             false);
