...
- **BROTH coordinator.** Fifteen lines in XOceanusProcessor to pump `sessionAge`, `concentrateDark`, and `spectralMass` to the other three BROTH engines. This unlocks the entire cooperative chemistry that makes BROTH a collection rather than four independent engines.
