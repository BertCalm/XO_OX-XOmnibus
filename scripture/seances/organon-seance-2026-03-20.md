...
1. **No standard 4-macro system** -- Organon has 10 unique params but no M1-M4 (CHARACTER/MOVEMENT/COUPLING/SPACE). This breaks the XOceanus gallery convention.
...
1. Add 4 standard XOceanus macros (CHARACTER -> catalystDrive+dampingCoeff, MOVEMENT -> phasonShift+lockIn, COUPLING -> signalFlux+membrane, SPACE -> noiseColor+dampingCoeff). ~50 LOC.
