...
**Goal:** Fix 5 known bugs in XOceanusEditor.h — stale tagline, missing mood filters, broken right-click, missing engine removal, vacuous mouseUp check.

**Architecture:** All changes are in `Source/UI/XOceanusEditor.h` (3006 lines, inline header). No new files. No DSP changes. No preset changes. Pure UI correctness fixes.
...
**Files:**
- Modify: `Source/UI/XOceanusEditor.h:2813`
...
**Files:**
- Modify: `Source/UI/XOceanusEditor.h:881-884`
...
**Files:**
- Modify: `Source/UI/XOceanusEditor.h` at 4 locations
...
**Files:**
- Modify: `Source/UI/XOceanusEditor.h` CompactEngineTile class
...
- [ ] **Step 4: Wire onEngineRemoved in XOceanusEditor**
...
```bash
git add Source/UI/XOceanusEditor.h
git commit -m "phase 1 complete: fix 5 broken UI elements in XOceanusEditor"
```
