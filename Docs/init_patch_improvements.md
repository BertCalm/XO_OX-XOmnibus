...
**Resolution for XOmnibus:** Performance instruments need immediate beauty; experimental instruments may benefit from neutral starts.
...
The seance verdict: *"The ERA triangle arrives at the XOmnibus dock with no luggage."* The B009 blessing is the ERA triangle (a 2D timbral crossfade that Buchla/Schulze/Vangelis/Pearlman all praised). No preset demonstrated it in a welcoming way.
