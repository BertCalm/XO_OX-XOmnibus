...
2. **Move to XOceanus Aether mood folder** — Once validated, copy relevant presets to `Presets/XOceanus/Aether/` for inclusion in the main factory library.
...
4. **Gallery demo** — Apotheosis should be the default-loaded preset for ODYSSEY in any public demo of XOceanus V007+.
