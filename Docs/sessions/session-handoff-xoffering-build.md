...
1. **Preset Audit Checklist skill** — created, registered globally + in XOceanus repo, committed
...
### Where to Build
**Directly in XOceanus:** `Source/Engines/Offering/`
...
### After Build
1. Register in `XOceanusProcessor.cpp` + `PresetManager.h`
