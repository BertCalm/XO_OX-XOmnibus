...
| M3 | COUPLING | Reserved for XOmnibus coupling amount. In standalone: crossfade between string ensemble and external audio (coupling input as grain/freeze source) | **The portal** — how much of another engine enters the pedalboard. |
