...
**The paradigm claim:** This is the first coupling system in XOmnibus where the coupling depth is constrained by material physics rather than by user preference. The engines know each other. The material knows its partner.
...
The KITCHEN quad needs four things that don't exist in XOmnibus yet:
