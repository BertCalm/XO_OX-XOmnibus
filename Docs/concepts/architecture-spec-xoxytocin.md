...
4. **Pitch TriangularCoupling as SDK feature** — document in `SDK/include/xomnibus/` as first-class platform innovation alongside KnotTopology. Write one SDK Field Guide post.
...
- `Docs/xomnibus_master_specification.md` section 3.1: add OXYTO row
- `Docs/seance_cross_reference.md`: add seance row after post-build seance
- `Source/XOmnibusProcessor.cpp`: register engine
...
- [ ] Docs/xomnibus_master_specification.md updated (engine table row)
- [ ] Docs/seance_cross_reference.md prepared for post-build entry
- [ ] Source/XOmnibusProcessor.cpp: REGISTER_ENGINE(OxytocinEngine, "OXYTO")
