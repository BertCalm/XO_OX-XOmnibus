...
**TriangularCoupling** adds a new protocol primitive to the fleet — the first coupling type that carries semantic structure. This alone justifies the engine's existence in the XOmnibus network.
