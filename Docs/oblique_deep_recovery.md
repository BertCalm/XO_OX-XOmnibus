...
- Four XOmnibus standard macros (FOLD, BOUNCE, COLOR, SPACE) were not yet implemented (Round 7D)
...
**Fix:** All four XOmnibus standard macros wired to audible DSP parameters.
