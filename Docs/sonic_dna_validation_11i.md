...
|------|--------|-----------|
| `Presets/XOceanus/Flux/Obscura_Chain_Fury.xometa` | Obscura | movement HIGH, density HIGH, aggression HIGH |
| `Presets/XOceanus/Flux/Obscura_Mantle_Convulsion.xometa` | Obscura | movement HIGH (0.92), density HIGH (0.88) |
| `Presets/XOceanus/Atmosphere/Obscura_Mass_Migration.xometa` | Obscura | movement HIGH (0.78), density HIGH (0.82) |
| `Presets/XOceanus/Aether/Obsidian_Glass_Void.xometa` | Obsidian | density LOW (0.08), space HIGH (0.92) |
| `Presets/XOceanus/Aether/Obsidian_Shimmer_Hall.xometa` | Obsidian | density LOW (0.25), space HIGH (0.88) |
| `Presets/XOceanus/Atmosphere/Osprey_Kelp_Forest.xometa` | Osprey | warmth HIGH (0.82), density HIGH (0.78) |
| `Presets/XOceanus/Foundation/Osprey_Thermal_Shore.xometa` | Osprey | warmth HIGH (0.78), density HIGH (0.75) |
