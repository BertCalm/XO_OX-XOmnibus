# XOceanus Preset System — Builder Specification
...
This document contains every decision the builder needs to implement the XOceanus preset system. No planning narrative — just specs.

---

## 1. Product Identity

- **Name:** XOceanus ("for all" — the collected works of XO_OX Designs)
...
| **Entangled** | Cross-coupled, reactive — the XOceanus signature | Gold |
...
| M3 | COUPLING | Cross-engine interaction strength (XOceanus signature) |
...
For MPC integration, XOceanus renders presets as multi-sampled keygroup programs:
...
| This spec | `synth_playbook/docs/xoceanus_preset_spec_for_builder.md` |
| .xometa schema | `synth_playbook/docs/xometa_schema.json` |
| .xometa examples | `synth_playbook/docs/xometa_examples.json` |
| Migrated presets | `Presets/XOceanus/{mood}/*.xometa` |
