...
This is extremely conservative. Even with control-rate modulation overhead, OBSIDIAN should not exceed **8%** of a single core under any configuration. This makes it the lightest engine in the entire XOceanus gallery.
