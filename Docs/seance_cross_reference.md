...
| XOverdub | OVERDUB | 7.4/10 | B004 Spring Reverb | None | D002: single sine LFO; D006: no MIDI CC | "The send/return architecture is brilliant but the LFO is a sine wave dressed in burlap." |
| XOnset | ONSET | Ahead of industry | B002 XVC + B006 Dual-Layer Blend | None | D005: zero LFOs | "The XVC matrix is 3 to 5 years ahead of any commercial drum machine — and it has no LFO." |
...
| XOutlook | OUTLOOK | 7.1/10 → ~8.0 (post-fix) | B039 candidate: Parallax Stereo Field (conditional) | P0-OUTLOOK-01–04 fixed 2026-03-23 | D004: look_delayMix/macroCoupling were dead (FIXED) | "The parallax stereo field is genuinely novel — note pitch as stereo depth. But the horizon scan is inert for 5/8 waveforms." — Buchla |

---

## Seance Score Ranking

| Rank | Engine | Score |
|------|--------|-------|
| 1 | ORGANON | 8/8 PASS |
| 2 | ORACLE | 8.6/10 |
| 3 | OPTIC | Revolutionary |
| 4 | OUROBOROS | Production-ready |
| 4 | OSPREY | APPROVE/CONDITIONAL |
| 4 | OSTERIA | Production-grade |
| 5 | OVERBITE | Full approval |
| 6 | ORBITAL | APPROVED |
| 7 | ONSET | Ahead of industry |
| 8 | ODYSSEY | 7.6/10 |
| 8 | OVERWORLD | 7.6/10 |
| 9 | OVERDUB | 7.4/10 |
| 10 | OBLONG | 7.x/10 |
...
| D006 (expression required) | OCEANIC, OVERWORLD, OBESE, OWLFISH, ODYSSEY (AfterTouch/ModWheel), ODDFELIX (linear velocity), OPAL, OBLONG |
...
|-----|--------|-------------|--------------|
| P0-01 | OBSIDIAN | R channel filter bypass — one filter never applied to right channel | `ObsidianEngine.h` stereo filter processing |
