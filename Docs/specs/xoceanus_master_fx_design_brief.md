# XOceanus Master FX Tract — Design Brief
...
Expand the Master FX tract from a 3-stage utility chain into a **6-stage creative instrument** that can produce sounds impossible with the engines alone. Each new stage draws from specific hardware inspiration while fitting the XOceanus character-first philosophy.
...
| `Source/XOceanusProcessor.h` | Include new headers |
| `Source/XOceanusProcessor.cpp` | Register 19 new APVTS parameters; wire prepare/process/reset |
| `Source/UI/XOceanusEditor.h` | Expand MasterFXSection to 6-section strip; add SequencerPanel |
| `Source/Core/PresetManager.h` | Parse/save new masterFX keys in `.xometa` |
| `Docs/xoceanus_master_specification.md` | Update §5.2 Master FX Rack |
...
| APVTS Parameters (28) | `Source/XOceanusProcessor.cpp` | **COMPLETE** |
| Transport sync (PPQ/BPM) | `Source/XOceanusProcessor.cpp` | **COMPLETE** |
| UI (6-section strip) | `Source/UI/XOceanusEditor.h` | **COMPLETE** |
