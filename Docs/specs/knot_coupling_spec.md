...
All other `CouplingType` values in XOceanus are directional: Engine A modulates Engine B's
...
Every engine in the XOceanus fleet handles `CouplingType::AmpToFilter`. It maps source
