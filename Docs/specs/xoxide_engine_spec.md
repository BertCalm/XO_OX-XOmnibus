...
OXIDE is the **Flavor Pro** of XOceanus. Where other engines synthesize, OXIDE transforms. Feed it a signal and it returns it changed — warmer, dirtier, stranger, richer. It is the engine you reach for when something technically correct needs to become musically true.
