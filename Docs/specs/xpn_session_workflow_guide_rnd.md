...
- Keep XOceanus plugin loaded on a dedicated insert channel for live processing
- Route the XOceanus send through the same coupling chain used during performance

### XOceanus Plugin Processing
Use XOceanus in the DAW to apply additional engine processing to recorded stems:
