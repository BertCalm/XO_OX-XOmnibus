...
xo_ox_version: "1.0"           # XOmnibus version targeted
```
...
6. **Playability pass** — Load 3–5 presets in XOmnibus and play them. Do they respond musically to velocity and mod wheel?
