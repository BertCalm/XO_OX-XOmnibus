...
`.xometa` presets are the source format — viewed in XOmnibus plugin, on desktop, in catalog listings. Maximum 30 characters. Full evocative name in this context.
