...
|---------|------|---------|
| 0.1 | 2026-03-22 | Initial public specification. Defines types 0x01–0x03 (Sympathetic, Complementary, Responsive). 16-byte packet format. Three compliance levels (L1 Listener, L2 Speaker, L3 Full). Reference implementation: XOmnibus. |
