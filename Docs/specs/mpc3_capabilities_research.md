...
```
For keygroup programs, the pad color should match the XOmnibus engine accent color
...
**OXPORT ACTION ITEM 14:** If XOmnibus ships as a VST3 plugin compatible with MPC Desktop 3.5+,
...
- Template for `<Program type="Plugin">` targeting XOmnibus VST3
