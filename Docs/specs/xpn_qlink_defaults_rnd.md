...
**Primary principle:** Q1–Q4 should map to the four XOmnibus macros wherever the macro hierarchy survives the XPN render:

| Q-Link | XOmnibus Macro | Underlying behavior |
|---|---|---|
