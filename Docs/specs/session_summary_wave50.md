...
| Tool                            | Purpose                                                        | CLI Usage                                                                                            |
| ------------------------------- | -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| audit_sonic_dna.py              | XOmnibus Sonic DNA Coverage Auditor                            | python3 audit_sonic_dna.py [--verbose]                                                               |
...
| generate_coupling_presets.py         | Generate cross-engine coupling presets for XOmnibus.                      | python generate_coupling_presets.py                                                                  |
| generate_library_fills.py            | XOmnibus Library Gap Fill Generator                                       | python generate_library_fills.py                                                                     |
| generate_onset_presets.py            | Generate XOnset .xometa preset files for the XOmnibus gallery.            | python generate_onset_presets.py                                                                     |
| generate_opal_presets.py             | Generate 100 XOpal factory presets for XOmnibus.                          | python generate_opal_presets.py                                                                      |
...
| generate_organon_presets.py          | Generate 120 XOrganon factory presets for XOmnibus.                       | python generate_organon_presets.py                                                                   |
| generate_ouroboros_presets.py        | Generate XOuroboros .xometa preset files for XOmnibus.                    | python generate_ouroboros_presets.py                                                                 |
| generate_overbite_presets.py         | Generate XOverbite .xometa preset files for XOmnibus.                     | python generate_overbite_presets.py                                                                  |
| generate_overworld_presets.py        | Generate XOverworld .xometa preset files for XOmnibus.                    | python generate_overworld_presets.py                                                                 |
...
| apply_renames.py              | Bulk rename script for XOmnibus preset files, documentation, and tools. | python apply_renames.py                                                                              |
...
| migrate_xocmeta_to_xometa.py  | OddfeliX .xocmeta → XOmnibus .xometa Migration Script                   | python3 migrate_xocmeta_to_xometa.py [--dry-run]                                                     |
...
| xpn_preset_browser.py       | Terminal browser for .xometa preset files.      | python xpn_preset_browser.py --presets-dir ./Presets/XOmnibus/ list --engine ONSET |
...
| Tool                           | Purpose                                                             | CLI Usage                                                                                            |
| ------------------------------ | ------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| compute_preset_dna.py          | XOmnibus Sonic DNA Fingerprint Generator                            | python3 compute_preset_dna.py [--dry-run] [--report]                                                 |
...
| rename_weak_presets.py         | Fleet-wide preset name elevation for XO_OX-XOmnibus                 | python3 rename_weak_presets.py --dry-run    # preview all changes                                    |
...
| xpn_auto_dna.py                | Automatically computes XOmnibus 6D Sonic DNA values from WAV audio. | python xpn_auto_dna.py sample.wav                                                                    |
...
| xpn_preset_mood_rebalancer.py  | XOmnibus Preset Mood Rebalancer                                     | python xpn_preset_mood_rebalancer.py <presets_dir> [--engine FILTER] [--suggest] [--apply] [--format |
...
| juce_to_mpc_workflow_rnd.md             | JUCE to MPC Workflow: XOmnibus to XPN Pack                           |
...
| sound_design_best_practices_xpn.md      | XOmnibus — Sound Design Best Practices for XPN/MPC Export            |
...
| utility_engine_concepts.md              | XOmnibus Utility Engine Concepts — R&D Brainstorm                    |
