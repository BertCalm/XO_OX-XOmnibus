...
**Examiner note**: Verify `lfo1Phase` and `lfo2Phase` advance per block in adapter code (not just in the standalone engine). Several past engines had LFO state not advancing in the XOmnibus context.
