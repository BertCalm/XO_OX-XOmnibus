# XOmnibus Coupling Preset Library
**Date:** 2026-03-14
...
Cross-engine coupling is XOmnibus's most powerful differentiator. Most factory presets use a single engine or layer two engines passively. This library is the first systematic collection devoted entirely to demonstrating what coupling *sounds like* at three distinct intensities — subtle, equal partnership, and full domination.
...
Receiving engine: **Overbite**. Directory: `Presets/XOmnibus/Entangled/Onset-Overbite/`
...
### Pair 2: OPAL → OVERDUB
Receiving engine: **Overdub**. Directory: `Presets/XOmnibus/Entangled/Opal-Overdub/`
...
### Pair 3: ODYSSEY → OPAL
Receiving engine: **Opal**. Directory: `Presets/XOmnibus/Entangled/Odyssey-Opal/`
...
Receiving engine: **Opal**. Directory: `Presets/XOmnibus/Entangled/Overworld-Opal/`
...
Receiving engine: **Organon**. Directory: `Presets/XOmnibus/Entangled/Oracle-Organon/`
...
Receiving engine: **Onset**. Directory: `Presets/XOmnibus/Entangled/Ouroboros-Onset/`
...
ONSET and OVERBITE form the most *physically immediate* coupling in the library. Percussion and bass have always been linked in music theory (the kick and bass sharing a frequency region, playing together or in opposition). XOmnibus makes this structural link *literally audible* — drum amplitude rewires bass character in real time. At Whisper intensity this is a sidechain; at Possession intensity it is a new synthesis paradigm where the drum IS the bass sound design.
...
ORACLE generates waveforms through genuine stochastic processes derived from Xenakis's GENDY algorithm — the most mathematically ancient synthesis technique in the fleet. ORGANON is based on Friston's Variational Free Energy principle — the most biologically sophisticated model in the fleet. Ancient probability mathematics feeding a living organism's metabolism is the deepest intellectual coupling in XOmnibus.
