...
**The reef needs a creation myth.** Why does OBRIX exist? The identity card says "baby brother of XOmnibus" and "modular brick synthesis." But the *story* is richer than that: OBRIX exists because XOmnibus has 39 engines, each with a fixed identity. A saber-toothed anglerfish. A jellyfish. An octopus. But the reef itself — the *ecosystem* — has no voice. OBRIX is the ecosystem speaking. It's not one creature. It's the place where creatures *live*. The reef doesn't have a fixed form — it grows, it adapts, it responds to its inhabitants.
...
| Identity story | "Baby brother of XOmnibus" | "OBRIX is not an instrument. It is a habitat." |
