...
- Placeholder text: change "Search engines..." to "Search 73 engines..." — the count gives users confidence in the scope.
...
| A4-01 | Picker — search prominence | SHOULD | `EnginePickerPopup.h` | Focused border = accent; placeholder = "Search 73 engines..." |
...
6. Manual check: Engine picker search field shows "Search 73 engines..." placeholder and focused accent border
