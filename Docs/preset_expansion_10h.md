...
**20 new presets total.** OSTERIA and OSPREY were the last two engines with zero XOmnibus-native presets. That gap is now closed.
...
**Zero engines with 0 presets in the XOmnibus fleet.** All 26 roadmap engines with implemented DSP now have at least one XOmnibus-native preset.
