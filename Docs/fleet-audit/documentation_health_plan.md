# XOceanus Documentation Health Plan
**Date:** 2026-03-20
...
The XOceanus documentation ecosystem is active and well-intentioned but carries four categories of debt:
...
**Files:** Docs/xoceanus_master_specification.md

### P1.6 Master Spec Document Hierarchy Incomplete
**Problem:** Master spec's Document Hierarchy table (section 1) lists 12 "foundation docs" but omits CLAUDE.md, seance_cross_reference, prism_sweep_final_report, xoceanus_landscape_2026, and all skills.
...
│   └── early-rnd/      (collections_, air_, pre-XOceanus work)
...
**Current state:** ODDFELIX through OWLFISH seances exist only as aggregated data in xoceanus_landscape_2026.md and seance_cross_reference.md. No individual verdict files.
...
### P4.4 Update xoceanus_landscape_2026.md
...
- All accuracy counts verified and matching code: ✅ coupling types (15), preset count (~19,500+), blessings (B001-B043)
