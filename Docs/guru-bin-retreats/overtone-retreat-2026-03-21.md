...
OVERTONE was added to XOmnibus on 2026-03-20, one of four engines integrated in a single session alongside ORBWEAVE, ORGANISM, and OWARE. Its seance score of 8.1/10 places it in the fleet's upper tier — all six doctrines pass, B028 (Continued Fraction Convergent Synthesis) is blessed by unanimous council, and the parameter library is extensive. It arrived with a large factory preset count distributed across all eight moods.
