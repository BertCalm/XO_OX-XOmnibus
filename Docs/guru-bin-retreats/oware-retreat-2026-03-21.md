...
OWARE arrived in XOmnibus on 2026-03-20 alongside OXBOW, designed as a tuned percussion synthesizer rooted in three academic citations: Chaigne & Doutaut (1997) mallet contact model, Rossing (2000) gamelan modal ratios, and Fletcher & Rossing (1998) marimba and vibraphone data. Its post-seance score of 9.2/10 made it the joint highest-scoring engine in the fleet of 44.
