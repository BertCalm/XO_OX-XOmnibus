...
Guru Bin Transcendental Vol 2 covers the six original standalone instruments that were complete before XOmnibus existed. These are the engines that built the XO_OX vocabulary from the ground up — the instruments that proved the design philosophy was real before a fleet gave it context.
...
- [ ] 90–120 Transcendental presets written and committed to `Presets/XOmnibus/`
