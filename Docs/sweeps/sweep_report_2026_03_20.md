# XOceanus Quality Sweep Report -- 2026-03-20
...
**15,199 `.xometa` preset files** found under `Presets/XOceanus/`.
...
contains **42 subdirectories**, and `XOceanusProcessor.cpp` has **42
...
`XOceanusProcessor.cpp` contains **42 `registered_` static variable
