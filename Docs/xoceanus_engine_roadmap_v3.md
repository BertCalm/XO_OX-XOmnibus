# XOceanus — Engine Expansion Roadmap: Volume 3
...
Volume 3 fills the final conceptual gaps in XOceanus with five engines drawn from underexplored or entirely novel synthesis science. Where Volumes 1–2 built on established paradigms (subtractive, granular, FM, wavetable, physical modeling, chaos), Volume 3 reaches into academic research, forgotten commercial dead-ends, and mathematical domains never before applied to real-time audio synthesis.
...
#### Phase 3.X — XOceanus Integration Prep
...
- Copy DSP headers to `XO_OX-XOceanus/Source/Engines/OBSIDIAN/`
- `REGISTER_ENGINE(XObsidianAdapter)`
- Copy presets to XOceanus Presets directory
