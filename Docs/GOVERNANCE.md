# XOmnibus Documentation Governance
...
|-------|-----------|-------------|
| **L1 — Canonical** | `CLAUDE.md`, `Docs/xomnibus_master_specification.md` | Single source of truth. Must be updated within 24h of any material change. |
...
| **L3 — Reference** | `Docs/xomnibus_sound_design_guides.md`, `Skills/*/SKILL.md`, `Docs/fleet_health_*.md` | Deep reference. Updated per engine/feature cycle. |
...
| `Docs/xomnibus_master_specification.md` | ✅ Required | Within 24h | Section 3.1 engine table, section 3 coupling if new type added |
| `Source/XOmnibusProcessor.cpp` | ✅ Required | On integration | Register engine, add to addParameters, SilencePeriod if needed |
...
| `Docs/xomnibus_sound_design_guides.md` | ✅ Required | Within 1 week | Add per-engine guide section |
...
| `Docs/xomnibus_master_specification.md` section 4.1 | ✅ Required | Within 24h |
| `Skills/coupling-interaction-cookbook/SKILL.md` | ✅ Required | Within 1 week |
| `Docs/xomnibus_new_engine_process.md` appendix | ⚠️ If notable | Within 1 week |
...
- `Docs/xo_mega_tool_preset_system.md` — superseded by `Docs/xomnibus_preset_spec_for_builder.md`
- `Docs/xo_mega_tool_visual_identity.md` — superseded by `Docs/xomnibus_technical_design_system.md`
