# Sonic DNA Audit — XOceanus Library
...
|------|--------|-------------|
| `Presets/XOceanus/Prism/Morph_Razor_Crest.xometa` | High brightness + High aggression | B=0.92 W=0.18 M=0.55 D=0.70 S=0.30 A=0.91 |
| `Presets/XOceanus/Foundation/Morph_Digital_Lattice.xometa` | Low warmth + High density | B=0.65 W=0.08 M=0.45 D=0.92 S=0.40 A=0.48 |
| `Presets/XOceanus/Atmosphere/Morph_Deep_Void.xometa` | High space + Low movement | B=0.42 W=0.55 M=0.04 D=0.52 S=0.96 A=0.08 |
| `Presets/XOceanus/Aether/Morph_Maximum_State.xometa` | Max everything | B=0.88 W=0.86 M=0.88 D=0.92 S=0.90 A=0.85 |
...
| File | Corner | DNA Summary |
|------|--------|-------------|
| `Presets/XOceanus/Prism/UV_Overload.xometa` | High brightness + High aggression | B=0.93 W=0.10 M=0.90 D=0.78 S=0.25 A=0.92 |
| `Presets/XOceanus/Flux/Ice_Lattice_Pulse.xometa` | Low warmth + High density | B=0.70 W=0.08 M=0.88 D=0.91 S=0.35 A=0.60 |
| `Presets/XOceanus/Aether/Deep_Signal_Drift.xometa` | High space + Low movement | B=0.48 W=0.62 M=0.12 D=0.42 S=0.96 A=0.08 |
| `Presets/XOceanus/Flux/Optic_Maximum_State.xometa` | Max everything | B=0.87 W=0.85 M=0.93 D=0.90 S=0.86 A=0.88 |
...
| File | Corner | DNA Summary |
|------|--------|-------------|
| `Presets/XOceanus/Prism/Oblique_Solar_Flare.xometa` | High brightness + High aggression | B=0.95 W=0.15 M=0.80 D=0.72 S=0.45 A=0.93 |
| `Presets/XOceanus/Foundation/Oblique_Velvet_Prism.xometa` | High warmth + Low density | B=0.22 W=0.88 M=0.35 D=0.22 S=0.65 A=0.08 |
| `Presets/XOceanus/Atmosphere/Oblique_Dark_Cathedral.xometa` | High space + Low movement | B=0.28 W=0.55 M=0.05 D=0.42 S=0.97 A=0.12 |
| `Presets/XOceanus/Entangled/Oblique_Maximum_State.xometa` | Max everything | B=0.88 W=0.82 M=0.92 D=0.90 S=0.88 A=0.90 |
