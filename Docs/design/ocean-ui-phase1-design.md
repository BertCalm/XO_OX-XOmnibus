...
| F2 | `SynthEngine` base class modification puts UI concerns in DSP interface, changes memory layout for 86 engines | **CANCELLED.** Do not touch `SynthEngine.h`. All visualization buffers live in the processor. |
