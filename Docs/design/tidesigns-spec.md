...
- Placeholder text: change "Search engines..." to "Search 86 engines..." — the count gives users confidence in the scope.
...
```cpp
searchField.setTextToShowWhenEmpty("Search 86 engines...",
...
| A4-01 | Picker — search prominence | SHOULD | `EnginePickerPopup.h` | Focused border = accent; placeholder = "Search 86 engines..." |
...
6. Manual check: Engine picker search field shows "Search 86 engines..." placeholder and focused accent border
