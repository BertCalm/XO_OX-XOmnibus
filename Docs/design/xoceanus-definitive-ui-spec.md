...
- Placeholder: Inter Regular 12pt, "Search 17,300+ presets...", `#777570`
...
The preset browser is not a list — it is a territory. All 17,300+ presets exist as points in 6D Sonic DNA space, projected onto a 2D map (PCA or t-SNE dimensionality reduction). The map fills the sidebar's PRESET tab.
...
This means XOceanus has not 17,300 presets but INFINITE sounds. The preset map is a continuous sound landscape where every position is a valid, musical sound.
