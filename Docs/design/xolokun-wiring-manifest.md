...
*Built from: `Source/UI/XOlokunEditor.h` (4,323 lines), `Docs/design/xolokun-spatial-architecture-v1.md`, `Docs/design/xolokun-definitive-ui-spec.md`, CLAUDE.md, and all 73 engine APVTS parameter specifications.*
