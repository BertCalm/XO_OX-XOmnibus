...
|------|------|--------|-------|
| **design-tokens.css** | `~/Documents/GitHub/XO_OX-XOmnibus/Site/design-tokens.css` | CANONICAL | 10 sections: Global Brand, Depth Zones, 73 Engine Colors, Anatomy, Glass Formula, PlaySurface, Typography, Type Scale (10 tokens), Spacing, Animation |
