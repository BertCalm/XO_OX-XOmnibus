...
| Name | Weights | Format | License | Use | Location |
|------|---------|--------|---------|-----|----------|
| **Nebulica** | Light, Regular, Medium, SemiBold, Bold, ExtraBold (6 weights) | WOFF2 | Commercial (Ui8 purchase) | XO-OX.org large display headings (aquarium section, hero overlays) | `~/Documents/GitHub/XO_OX-XOlokun/Site/fonts/` + source pack at `~/Downloads/nebulica_NjliZmQ4YWYzNzVhNWYwMDk1NzM2MDE0/OTF/` |
| **Chrys** | Light, Regular, Distorted (3 weights) | WOFF + OTF | Commercial (Ui8 purchase) | XO-OX.org specialty headings; Distorted variant for avant-garde contexts | `~/Documents/GitHub/XO_OX-XOlokun/Site/fonts/` + source at `~/Downloads/chrys_sans_serif_font_family_NjliZmQ4YWYzNzVhNWYwMDk1NzM2MDE0/OTF/` |
...
|------|-------|--------|---------|-----|----------|
| **HINO Aloraglyphs** | Symbolic glyphs | OTF | Commercial (Ui8 purchase) | Decorative glyph accents in site panels and engine cards | `~/Documents/GitHub/XO_OX-XOlokun/Site/fonts/HINOAloraglyphs.otf` |
| **HINO Cryptaglyphs** | Runic/cipher symbols | OTF | Commercial (Ui8 purchase) | Cipher/rune accents in mythology-themed UI elements | `~/Documents/GitHub/XO_OX-XOlokun/Site/fonts/HINOCryptaglyphs-Regular.otf` |
| **HINO Cyberglyphs** | Cyber/tech symbols | OTF | Commercial (Ui8 purchase) | Cyber/tech accent glyphs for plugin chrome details | `~/Documents/GitHub/XO_OX-XOlokun/Site/fonts/HINOCyberglyphs.otf` |
...
|------|------|--------|-------|
| **design-tokens.css** | `~/Documents/GitHub/XO_OX-XOlokun/Site/design-tokens.css` | CANONICAL | 10 sections: Global Brand, Depth Zones, 71 Engine Colors, Anatomy, Glass Formula, PlaySurface, Typography, Type Scale (10 tokens), Spacing, Animation |
| **engine-creature-map.json** | `~/Documents/GitHub/XO_OX-XOlokun/Site/engine-creature-map.json` | CANONICAL | Engine name → mythology mapping → accent color |
...
| **Site LED characters** | Pre-rendered LED sprites | Already deployed in XO-OX.org panels | `~/Documents/GitHub/XO_OX-XOlokun/Site/img/led/` |
...
- Chrys TTF: `~/Downloads/Audio UI/KNOBS/` — wait, check: `~/Documents/GitHub/XO_OX-XOlokun/Site/fonts/Chrys-Regular.woff` — need source OTF from `~/Downloads/chrys_.../OTF/`
