...
- **4 engine slots** simultaneously, drawn from 76 swappable engines
...
| └──────────┘ └──────────┘ └──────────┘ └──────────┘    |
| [... 76 cards, filterable, scrollable ...]              |
+══════════════════════════════════════════════════════════+
```
...
|---|-----------|---------|--------------|
| 1 | **RotaryKnob** | All 76 | Size (24/32/40/56pt), accent, filmstrip set, mod ring (V1.1) |
| 2 | **CollapsibleSection** | All 76 | Name, color, hero params, expanded/collapsed |
