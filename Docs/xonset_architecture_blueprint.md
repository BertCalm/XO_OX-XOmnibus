...
**Engine location:** `Source/Engines/Onset/OnsetEngine.h` (native XOceanus engine)

---

## 1. Current Implementation State

OnsetEngine.h: **1041 lines**, fully integrated in XOceanus gallery.
...
| DSP location | `Source/Engines/Onset/OnsetEngine.h` (inline, native XOceanus) |
