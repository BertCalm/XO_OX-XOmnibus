...
All presets live in `Presets/XOceanus/Flux/Onset/XVC/` except Demo 12 which is in `Presets/XOceanus/Entangled/`.
...
**File:** `Presets/XOceanus/Entangled/Onset_XVC_Dub_Mesh.xometa`
...
Six presets exploring coupling patterns not covered in the original 12 demos. All live in `Presets/XOceanus/Flux/Onset/XVC/`.
...
*Presets in: `Presets/XOceanus/Flux/Onset/XVC/` (17 presets) + `Presets/XOceanus/Entangled/Onset_XVC_Dub_Mesh.xometa` (1 preset)*
