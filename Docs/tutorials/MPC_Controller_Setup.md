# MPC Controller Setup for XOceanus

Use any MPC as a hands-on controller for XOceanus in your DAW.
...
3. **Load XOceanus** in your DAW on a track receiving MIDI from the MPC.
...
| MPC Control | XOceanus Target | Notes |
|---|---|---|
...
| Q-Link | CC | XOceanus Macro | What it does |
|---|---|---|---|
...
MPC pads send channel aftertouch. Map this to filter modulation in your DAW's MIDI learn or XOceanus host:
...
- The extra Q-Links make this the best XOceanus controller in the lineup
...
- Best choice for playing melodic XOceanus engines
...
1. Right-click (or Ctrl-click) the XOceanus knob you want to control
...
### Tip
Save your Q-Link template on the MPC so you don't have to reassign CCs every session. Name it something like "XOceanus 4 Macros" and load it whenever you open a session.
