# Documentation Index
Generated: 2026-03-19 | Updated: 2026-04-03 | Total: 300+ files across 30 subdirectories
...
## Build & Verification (Historical Snapshots)
...
## XO Mega Tool (Historical — Predates Oxport)
...
- [concepts/README.md](concepts/README.md) — Concepts index
- [concepts/aquatic_master_fx_concept.md](concepts/aquatic_master_fx_concept.md) — Aquatic FX concept
- [concepts/artwork_collection_overview.md](concepts/artwork_collection_overview.md) — Artwork collection
- [concepts/chef_quad_concept_brief.md](concepts/chef_quad_concept_brief.md) — Chef Quad concept
- [concepts/culinary_collection_overview.md](concepts/culinary_collection_overview.md) — Culinary collection
- [concepts/dual_quad_relationships.md](concepts/dual_quad_relationships.md) — Dual quad relationships
- [concepts/oddfelix_concept_brief.md](concepts/oddfelix_concept_brief.md) — OddfeliX concept
- [concepts/oddoscar_concept_brief.md](concepts/oddoscar_concept_brief.md) — OddOscar concept
- [concepts/overworld-dual-triangle-era.md](concepts/overworld-dual-triangle-era.md) — OVERWORLD dual triangle ERA
- [concepts/travel_water_collection_overview.md](concepts/travel_water_collection_overview.md) — Travel/Water collection
- [concepts/water_quad_concept_brief.md](concepts/water_quad_concept_brief.md) — Water Quad concept
- [concepts/xo_chord_machine_design.md](concepts/xo_chord_machine_design.md) — XO Chord Machine design
- [concepts/xobbligato_concept_brief.md](concepts/xobbligato_concept_brief.md) — OBBLIGATO concept
- [concepts/xobese_concept_brief.md](concepts/xobese_concept_brief.md) — OBESE concept
- [concepts/xoblique_concept_brief.md](concepts/xoblique_concept_brief.md) — OBLIQUE concept
- [concepts/xoblongbob_concept_brief.md](concepts/xoblongbob_concept_brief.md) — OBLONG concept
- [concepts/xobscura_concept_brief.md](concepts/xobscura_concept_brief.md) — OBSCURA concept
- [concepts/xobsidian_concept_brief.md](concepts/xobsidian_concept_brief.md) — OBSIDIAN concept
- [concepts/xoceandeep_concept_brief.md](concepts/xoceandeep_concept_brief.md) — OCEANDEEP concept
- [concepts/xoceandeep_engine_spec.md](concepts/xoceandeep_engine_spec.md) — OCEANDEEP engine spec
- [concepts/xoceanic_concept_brief.md](concepts/xoceanic_concept_brief.md) — OCEANIC concept
- [concepts/xoceanic_integration_spec.md](concepts/xoceanic_integration_spec.md) — OCEANIC integration
- [concepts/xoceanic_master_spec.md](concepts/xoceanic_master_spec.md) — OCEANIC master spec
- [concepts/xocelot_concept_brief.md](concepts/xocelot_concept_brief.md) — OCELOT concept
...
- [specs/air_plugin_research.md](specs/air_plugin_research.md) — AIR plugin research
- [specs/collections_kitchen_engine_concepts.md](specs/collections_kitchen_engine_concepts.md) — Kitchen collection concepts
- [specs/collections_travel_artwork_concepts.md](specs/collections_travel_artwork_concepts.md) — Travel/Artwork concepts
- [specs/community_marketplace_rnd.md](specs/community_marketplace_rnd.md) — Community marketplace R&D
- [specs/community_pack_submission_rnd.md](specs/community_pack_submission_rnd.md) — Community pack submission R&D
- [specs/coupling_dna_pack_design_rnd.md](specs/coupling_dna_pack_design_rnd.md) — Coupling DNA pack R&D
- [specs/elk_audio_os_research.md](specs/elk_audio_os_research.md) — Elk Audio OS research
- [specs/engine_sound_design_philosophy_rnd.md](specs/engine_sound_design_philosophy_rnd.md) — Sound design philosophy
- [specs/field_guide_posts_pipeline.md](specs/field_guide_posts_pipeline.md) — Field Guide pipeline
- [specs/fleet_render_automation_spec.md](specs/fleet_render_automation_spec.md) — Fleet render automation
- [specs/free_taster_pack_spec.md](specs/free_taster_pack_spec.md) — Free taster pack spec
- [specs/generative_kit_architectures_rnd.md](specs/generative_kit_architectures_rnd.md) — Generative kit R&D
- [specs/juce_to_mpc_workflow_rnd.md](specs/juce_to_mpc_workflow_rnd.md) — JUCE→MPC workflow
- [specs/kit_curation_innovation_rnd.md](specs/kit_curation_innovation_rnd.md) — Kit curation R&D
- [specs/kit_innovation_master_roadmap.md](specs/kit_innovation_master_roadmap.md) — Kit innovation roadmap
- [specs/live_performance_xpn_rnd.md](specs/live_performance_xpn_rnd.md) — Live performance XPN R&D
- [specs/mpc_evolving_capabilities_research.md](specs/mpc_evolving_capabilities_research.md) — MPC capabilities research
- [specs/mpc_os_35_format_innovations_rnd.md](specs/mpc_os_35_format_innovations_rnd.md) — MPC OS 3.5 R&D
