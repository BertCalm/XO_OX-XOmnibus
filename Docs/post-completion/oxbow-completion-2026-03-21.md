...
Registered in `Source/XOmnibusProcessor.cpp` at line 228, under the comment "Singularity Collection — OXBOW (entangled reverb synth engine)":
...
The `Docs/xomnibus_sound_design_guides.md` currently has 39 numbered entries ending at **## 38. OUIE**. OXBOW is not present. The CLAUDE.md Key Files entry still reads "34 of 34 engines in unified guide" — this count is stale (44 engines registered; guide covers 38).

**Action required:** Add entry "## 39. OXBOW — Entangled Reverb Synthesis" to `Docs/xomnibus_sound_design_guides.md`.
...
| Check | Status |
|-------|--------|
| 1. Engine registered in XOmnibusProcessor.cpp | PASS |
| 2. CLAUDE.md updated | PASS |
...
*Checklist authored 2026-03-21. Next action: run `/synth-seance` on OXBOW, then add Appendix A entry to `Docs/xomnibus_sound_design_guides.md`.*
