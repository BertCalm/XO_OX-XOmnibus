...
**Note:** The Overworld fix lands in the external repo `~/Documents/GitHub/XOverworld/src/engine/` because `OverworldEngine.h` in XOmnibus is a thin adapter that includes `VoicePool.h` via `target_include_directories`.
...
2. No legato or glide wired through the XOmnibus adapter.
...
- `/Users/joshuacramblet/Documents/GitHub/XO_OX-XOmnibus/Source/Engines/Ocelot/OcelotVoice.h`
...
- `/Users/joshuacramblet/Documents/GitHub/XO_OX-XOmnibus/Source/Engines/Morph/MorphEngine.h`
...
The standalone XOverworld does not have a `ow_glide` pitch portamento parameter (it has `ow_eraPortaTime` for ERA position glide, which is different). Adding pitch portamento requires: (1) storing per-voice previous frequency in `Voice`, (2) adding `ow_glide` to the XOmnibus parameter layout, (3) passing it through `applyParams`. Medium effort, low urgency.
...
**Files changed:**
- `/Users/joshuacramblet/Documents/GitHub/XO_OX-XOmnibus/Source/Engines/Oblique/ObliqueEngine.h`
...
**Files changed:**
- `/Users/joshuacramblet/Documents/GitHub/XO_OX-XOmnibus/Source/Engines/Osprey/OspreyEngine.h`
