# XOmnibus Server Setup — Supabase
...
2. Click **New Project**
3. Name it `xomnibus` (or whatever you like)
...
This comfortably handles tens of thousands of XOmnibus users. If you outgrow
